...
HRESULT CStart_Button::NativeConstruct(void * pArg)
{
	...
	if (FAILED(D3DXCreateTextureFromFileExW(m_pGraphicDevice, TEXT("../bin/resources/Image/UI/Button/StartButton_0.tga"), 512, 128, 0, 0, D3DFMT_A8R8G8B8,
...
HRESULT CStart_Button::SetUp_ConstantTable()
{
